...
{
    abstract class AbstractNameTupleElementCodeRefactoringProvider<TArgumentSyntax, TTupleExpressionSyntax> : SyntaxBasedCodeRefactoringProvider<TArgumentSyntax>
