...
namespace Microsoft.CodeAnalysis.Diagnostics
{
    ...
    internal partial class DiagnosticAnalyzerService : IDiagnosticAnalyzerService
    {
        ...
        public ImmutableArray<DiagnosticDescriptor> GetDiagnosticDescriptors(DiagnosticAnalyzer analyzer, ProjectId projectIdOpt)
        {
            return _hostAnalyzerManager.GetDiagnosticDescriptors(analyzer, projectIdOpt);
        }
