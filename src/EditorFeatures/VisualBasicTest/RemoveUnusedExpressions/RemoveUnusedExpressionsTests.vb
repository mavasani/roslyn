...
Imports Microsoft.CodeAnalysis.VisualBasic.RemoveUnusedExpressions

Namespace Microsoft.CodeAnalysis.Editor.VisualBasic.UnitTests.RemoveUnusedExpressions
    '    Public Class RemoveUnusedExpressionsTests
    '        Inherits AbstractVisualBasicDiagnosticProviderBasedUserDiagnosticTest
    '        Friend Overrides Function CreateDiagnosticProviderAndFixer(workspace As Workspace) As (DiagnosticAnalyzer, CodeFixProvider)
    '            Return (New VisualBasicRemoveUnusedExpressionsDiagnosticAnalyzer(), New VisualBasicRemoveUnusedExpressionsCodeFixProvider())
    '        End Function
