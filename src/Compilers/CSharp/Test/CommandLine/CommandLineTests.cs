...
class C
{
    void M(int i)
    {
        switch (i)
        {
            ...
            // Verify that compiler warning CS1522 cannot be suppressed with diagnostic suppressor.
            output = VerifyOutput(srcDirectory, srcFile, expectedWarningCount: 1, includeCurrentAssemblyAsAnalyzerReference: false,
...
class C
{
    ...
    private readonly int f;
            ...
            // Verify that compiler warning CS0169 cannot be suppressed with diagnostic suppressor.
            output = VerifyOutput(srcDirectory, srcFile, expectedWarningCount: 1, includeCurrentAssemblyAsAnalyzerReference: false,
...
class C { }";
            ...
            var suppressionMessage = string.Format(CodeAnalysisResources.SuppressionDiagnosticDescriptorMessage,
                ...
                $"{suppressor.SuppressionDescriptor.Id}: {suppressor.SuppressionDescriptor.Description}");
