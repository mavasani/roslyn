...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests
{
    public partial class DiagnosticSuppressorTests : CompilingTestBase
    {
        ...
        public void TestNoSuppression_CompilerSyntaxWarning()
        {
...
class C
{
    void M(int i)
    {
        switch (i)
        {
            ...
            // Verify compiler syntax warning cannot be suppressed with a suppressor.
        ...
        [Fact, WorkItem(20242, "https://github.com/dotnet/roslyn/issues/20242")]
        public void TestNoSuppression_CompilerSemanticWarning()
        {
            string source = @"
class C
{
    ...
    private readonly int f;
            ...
            // Verify compiler semantic warning cannot be suppressed with a suppressor.
...
class C
{
    void M(UndefinedType x) { }
        ...
        public void TestSuppression_MultipleSuppressors_DifferentDiagnostic()
        {
            ...
            var expectedAnalyzerDiagnostic = Diagnostic("ID1000", source);
            var analyzer = new CompilationAnalyzerWithSeverity(DiagnosticSeverity.Warning, configurable: true);
            ...
            compilation.VerifySuppressedDiagnostics(analyzersAndSuppressors, null, null, true, expectedAnalyzerDiagnostic);
        }
        ...
        public void TestDiagnosticOnMissingFeatureFlag()
        {
            ...
            var expectedDiagnostics = new[]
            {
                ...
                Diagnostic("AD0001").WithArguments("Microsoft.CodeAnalysis.CommonDiagnosticAnalyzers+DiagnosticSuppressorForId",
                                                   ...
                                                   CodeAnalysisResources.DiagnosticSuppresorFeatureDisabled).WithLocation(1, 1)
            };
...
class C { }";
        ...
        [Fact, WorkItem(20242, "https://github.com/dotnet/roslyn/issues/20242")]
        public void TestSuppressionMessage_DiagnosticSuppressor()
        {
            string source = @"class C1 { }";
            var compilation = CreateCompilationWithMscorlib45(source, parseOptions: TestOptions.RegularWithDiagnosticSuppressorFeature);
            compilation.VerifyDiagnostics();
        ...
        [Fact, WorkItem(20242, "https://github.com/dotnet/roslyn/issues/20242")]
        public void TestSuppressionMessage_Pragma()
        {
            string source = @"
class C1
{
#pragma warning disable CS0169
    ...
    private readonly int f;
            ...
            var compilation = CreateCompilationWithMscorlib45(source, options: compilationOptions);
            var diagnostics = compilation.GetDiagnostics();
            diagnostics.Verify(
                // (6,26): warning CS0169: The field 'C1.f' is never used
                //     private readonly int f;
        ...
        [Fact, WorkItem(20242, "https://github.com/dotnet/roslyn/issues/20242")]
        public void TestSuppressionMessage_SuppressMessageAttribute()
        {
            var analyzer = new CompilationAnalyzerWithSeverity(DiagnosticSeverity.Warning, configurable: true);
            string source = $@"[assembly: System.Diagnostics.CodeAnalysis.SuppressMessage(""{analyzer.Descriptor.Category}"", ""{analyzer.Descriptor.Id}"")]
class C1 {{ }}";
            var compilation = CreateCompilationWithMscorlib45(source, parseOptions: TestOptions.RegularWithDiagnosticSuppressorFeature);
            compilation.VerifyDiagnostics();

            var expectedDiagnostic = Diagnostic(analyzer.Descriptor.Id, source);
            var diagnostics = compilation.GetAnalyzerDiagnostics(new DiagnosticAnalyzer[] { analyzer }, reportSuppressedDiagnostics: true);
