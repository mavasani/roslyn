...
";
            ...
            var tree = CSharpSyntaxTree.ParseText(string.Format(source, treeNum++), path: $"sourceFile{treeNum}.cs");
            builder.Add(tree);
...
";
            var autoGeneratedSource = autoGeneratedPrefix + source;
            tree = CSharpSyntaxTree.ParseText(string.Format(source, treeNum++), path: $"sourceFile{treeNum}.cs");
            builder.Add(tree);
            ...
            // Verify, code block action diagnostics.
            CreateCompilationWithMscorlib45(trees)
                .VerifyDiagnostics()
                .VerifyAnalyzerDiagnostics(analyzers, null, null, logAnalyzerExceptionAsDiagnostics: false,
                    expected: new[] {
                        Diagnostic(CSharpCodeBlockObjectCreationAnalyzer.DiagnosticDescriptor.Id, "new C()").WithLocation(5, 18)
