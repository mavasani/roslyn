...
";
            ...
            var autoGeneratedPrefix = @"// <auto-generated>
";
            tree = CSharpSyntaxTree.ParseText(string.Format(autoGeneratedPrefix + source, treeNum++), path: "SourceFileWithAutoGeneratedComment.cs");
            builder.Add(tree);
            ...
            // (1) Verify default mode of analysis - analyzer *not invoked* on generated code.
            //   (a) No analyzer callback on generated code
            var analyzers = new DiagnosticAnalyzer[] { new GeneratedCodeAnalyzer(enableAnalysisOnGeneratedCode: false) };
            compilation.VerifyAnalyzerDiagnostics(analyzers, null, null, logAnalyzerExceptionAsDiagnostics: false,
                expected: new[] {
                    Diagnostic("GeneratedCodeAnalyzerId", "[").WithArguments("SourceFileRegular.cs").WithLocation(2, 1),
                    Diagnostic("GeneratedCodeAnalyzerId", "[").WithArguments("AssemblyInfo.cs").WithLocation(2, 1),
                    Diagnostic("GeneratedCodeAnalyzerId", "NonGeneratedCode1").WithArguments("NonGeneratedCode1").WithLocation(8, 7),
                    Diagnostic("GeneratedCodeAnalyzerId", "NonGeneratedCode2").WithArguments("NonGeneratedCode2").WithLocation(8, 7)
                });

            //   (b) Diagnostics reported on generated code from non-generated code are suppressed.
            analyzers = new DiagnosticAnalyzer[] { new GeneratedCodeAnalyzer(enableAnalysisOnGeneratedCode: false, reportDiagnosticsOnNestedFromContaining: true) };
            compilation.VerifyAnalyzerDiagnostics(analyzers, null, null, logAnalyzerExceptionAsDiagnostics: false,
                expected: new[] {
                    Diagnostic("GeneratedCodeAnalyzerId", "[").WithArguments("SourceFileRegular.cs").WithLocation(2, 1),
                    Diagnostic("GeneratedCodeAnalyzerId", "[").WithArguments("AssemblyInfo.cs").WithLocation(2, 1),
            ...
            // (2) Verify EnableAnalysisOnGeneratedCode - analyzer *invoked* on generated code and diagnostics not suppressed.
            analyzers = new DiagnosticAnalyzer[] { new GeneratedCodeAnalyzer(enableAnalysisOnGeneratedCode: true) };
            compilation.VerifyAnalyzerDiagnostics(analyzers, null, null, logAnalyzerExceptionAsDiagnostics: false,
                expected: new[] {
                    Diagnostic("GeneratedCodeAnalyzerId", "GeneratedCode1").WithArguments("GeneratedCode1").WithLocation(3, 7),
                    Diagnostic("GeneratedCodeAnalyzerId", "GeneratedCode2").WithArguments("GeneratedCode2").WithLocation(3, 7),
                    Diagnostic("GeneratedCodeAnalyzerId", "GeneratedCode3").WithArguments("GeneratedCode3").WithLocation(3, 7),
                    Diagnostic("GeneratedCodeAnalyzerId", "GeneratedCode4").WithArguments("GeneratedCode4").WithLocation(3, 7),
                    Diagnostic("GeneratedCodeAnalyzerId", "GeneratedCode5").WithArguments("GeneratedCode5").WithLocation(3, 7),
                    Diagnostic("GeneratedCodeAnalyzerId", "GeneratedCode6").WithArguments("GeneratedCode6").WithLocation(3, 7),
                    Diagnostic("GeneratedCodeAnalyzerId", "GeneratedCode7").WithArguments("GeneratedCode7").WithLocation(3, 7),
                    Diagnostic("GeneratedCodeAnalyzerId", "GeneratedCode8").WithArguments("GeneratedCode8").WithLocation(3, 7),
                    Diagnostic("GeneratedCodeAnalyzerId", "GeneratedCode9").WithArguments("GeneratedCode9").WithLocation(4, 7),
                    Diagnostic("GeneratedCodeAnalyzerId", "Nested1").WithArguments("Nested1").WithLocation(5, 19),
                    Diagnostic("GeneratedCodeAnalyzerId", "Nested2").WithArguments("Nested2").WithLocation(5, 19),
                    Diagnostic("GeneratedCodeAnalyzerId", "Nested3").WithArguments("Nested3").WithLocation(5, 19),
                    Diagnostic("GeneratedCodeAnalyzerId", "Nested4").WithArguments("Nested4").WithLocation(5, 19),
                    Diagnostic("GeneratedCodeAnalyzerId", "Nested5").WithArguments("Nested5").WithLocation(5, 19),
                    Diagnostic("GeneratedCodeAnalyzerId", "Nested6").WithArguments("Nested6").WithLocation(5, 19),
                    Diagnostic("GeneratedCodeAnalyzerId", "Nested7").WithArguments("Nested7").WithLocation(5, 19),
                    Diagnostic("GeneratedCodeAnalyzerId", "Nested8").WithArguments("Nested8").WithLocation(5, 19),
                    Diagnostic("GeneratedCodeAnalyzerId", "Nested9").WithArguments("Nested9").WithLocation(6, 19),
                    Diagnostic("GeneratedCodeAnalyzerId", "NonGeneratedCode1").WithArguments("NonGeneratedCode1").WithLocation(8, 7),
                    Diagnostic("GeneratedCodeAnalyzerId", "NonGeneratedCode2").WithArguments("NonGeneratedCode2").WithLocation(8, 7),
                    Diagnostic("GeneratedCodeAnalyzerId", "NonGeneratedCode3").WithArguments("NonGeneratedCode3").WithLocation(8, 7),
                    Diagnostic("GeneratedCodeAnalyzerId", "NonGeneratedCode4").WithArguments("NonGeneratedCode4").WithLocation(8, 7),
                    Diagnostic("GeneratedCodeAnalyzerId", "NonGeneratedCode5").WithArguments("NonGeneratedCode5").WithLocation(8, 7),
                    Diagnostic("GeneratedCodeAnalyzerId", "NonGeneratedCode6").WithArguments("NonGeneratedCode6").WithLocation(8, 7),
                    Diagnostic("GeneratedCodeAnalyzerId", "NonGeneratedCode7").WithArguments("NonGeneratedCode7").WithLocation(8, 7),
                    Diagnostic("GeneratedCodeAnalyzerId", "NonGeneratedCode8").WithArguments("NonGeneratedCode8").WithLocation(8, 7),
                    Diagnostic("GeneratedCodeAnalyzerId", "NonGeneratedCode9").WithArguments("NonGeneratedCode9").WithLocation(9, 7),
                    Diagnostic("GeneratedCodeAnalyzerId", "NestedGeneratedCode1").WithArguments("NestedGeneratedCode1").WithLocation(11, 19),
                    Diagnostic("GeneratedCodeAnalyzerId", "NestedGeneratedCode2").WithArguments("NestedGeneratedCode2").WithLocation(11, 19),
                    Diagnostic("GeneratedCodeAnalyzerId", "NestedGeneratedCode3").WithArguments("NestedGeneratedCode3").WithLocation(11, 19),
                    Diagnostic("GeneratedCodeAnalyzerId", "NestedGeneratedCode4").WithArguments("NestedGeneratedCode4").WithLocation(11, 19),
                    Diagnostic("GeneratedCodeAnalyzerId", "NestedGeneratedCode5").WithArguments("NestedGeneratedCode5").WithLocation(11, 19),
                    Diagnostic("GeneratedCodeAnalyzerId", "NestedGeneratedCode6").WithArguments("NestedGeneratedCode6").WithLocation(11, 19),
                    Diagnostic("GeneratedCodeAnalyzerId", "NestedGeneratedCode7").WithArguments("NestedGeneratedCode7").WithLocation(11, 19),
                    Diagnostic("GeneratedCodeAnalyzerId", "NestedGeneratedCode8").WithArguments("NestedGeneratedCode8").WithLocation(11, 19),
                    Diagnostic("GeneratedCodeAnalyzerId", "NestedGeneratedCode9").WithArguments("NestedGeneratedCode9").WithLocation(12, 19),
                    Diagnostic("GeneratedCodeAnalyzerId", "[").WithArguments("SourceFileRegular.cs").WithLocation(2, 1),
                    Diagnostic("GeneratedCodeAnalyzerId", "[").WithArguments("AssemblyInfo.cs").WithLocation(2, 1),
                    Diagnostic("GeneratedCodeAnalyzerId", "[").WithArguments("TemporaryGeneratedFile_036C0B5B-1481-4323-8D20-8F5ADCB23D92.cs").WithLocation(2, 1),
                    Diagnostic("GeneratedCodeAnalyzerId", "[").WithArguments("Test.designer.cs").WithLocation(2, 1),
                    Diagnostic("GeneratedCodeAnalyzerId", "[").WithArguments("Test.Designer.cs").WithLocation(2, 1),
                    Diagnostic("GeneratedCodeAnalyzerId", "[").WithArguments("Test.generated.cs").WithLocation(2, 1),
                    Diagnostic("GeneratedCodeAnalyzerId", "[").WithArguments("Test.g.cs").WithLocation(2, 1),
                    Diagnostic("GeneratedCodeAnalyzerId", "[").WithArguments("Test.g.i.cs").WithLocation(2, 1),
                    Diagnostic("GeneratedCodeAnalyzerId", "[").WithArguments("SourceFileWithAutoGeneratedComment.cs").WithLocation(3, 1)
                });
        }
    }
}
