...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal abstract class DecisionTreeBuilder
    {
        ...
        {
            return Binder.ExpressionOfTypeMatchesPatternType(this._conversions, expressionType, patternType, ref useSiteDiagnostics, out Conversion conversion, null, false);
        }
