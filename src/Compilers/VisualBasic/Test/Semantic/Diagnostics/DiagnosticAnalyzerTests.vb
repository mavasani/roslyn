...
End Class
            ...
            Dim analyzers = New DiagnosticAnalyzer() {New GeneratedCodeAnalyzer(enableAnalysisOnGeneratedCode:=False)}
            compilation.VerifyAnalyzerDiagnostics(analyzers, Nothing, Nothing, False,
                {
                    Diagnostic("GeneratedCodeAnalyzerId", "<").WithArguments("SourceFileRegular.vb").WithLocation(2, 1),
                    Diagnostic("GeneratedCodeAnalyzerId", "<").WithArguments("AssemblyInfo.vb").WithLocation(2, 1),
            ...
            compilation.VerifyAnalyzerDiagnostics(analyzers, Nothing, Nothing, False,
                {
                    ...
                    Diagnostic("GeneratedCodeAnalyzerId", "Nested1").WithArguments("Nested1").WithLocation(4, 16),
                    Diagnostic("GeneratedCodeAnalyzerId", "Nested2").WithArguments("Nested2").WithLocation(4, 16),
                    Diagnostic("GeneratedCodeAnalyzerId", "Nested3").WithArguments("Nested3").WithLocation(4, 16),
                    Diagnostic("GeneratedCodeAnalyzerId", "Nested4").WithArguments("Nested4").WithLocation(4, 16),
                    Diagnostic("GeneratedCodeAnalyzerId", "Nested5").WithArguments("Nested5").WithLocation(4, 16),
                    Diagnostic("GeneratedCodeAnalyzerId", "Nested6").WithArguments("Nested6").WithLocation(4, 16),
                    Diagnostic("GeneratedCodeAnalyzerId", "Nested7").WithArguments("Nested7").WithLocation(4, 16),
                    Diagnostic("GeneratedCodeAnalyzerId", "Nested8").WithArguments("Nested8").WithLocation(4, 16),
                    Diagnostic("GeneratedCodeAnalyzerId", "Nested9").WithArguments("Nested9").WithLocation(5, 16),
                    Diagnostic("GeneratedCodeAnalyzerId", "NonGeneratedCode1").WithArguments("NonGeneratedCode1").WithLocation(8, 7),
                    Diagnostic("GeneratedCodeAnalyzerId", "NonGeneratedCode2").WithArguments("NonGeneratedCode2").WithLocation(8, 7),
                    ...
                    Diagnostic("GeneratedCodeAnalyzerId", "NestedGeneratedCode1").WithArguments("NestedGeneratedCode1").WithLocation(10, 16),
                    Diagnostic("GeneratedCodeAnalyzerId", "NestedGeneratedCode2").WithArguments("NestedGeneratedCode2").WithLocation(10, 16),
                    Diagnostic("GeneratedCodeAnalyzerId", "NestedGeneratedCode3").WithArguments("NestedGeneratedCode3").WithLocation(10, 16),
                    Diagnostic("GeneratedCodeAnalyzerId", "NestedGeneratedCode4").WithArguments("NestedGeneratedCode4").WithLocation(10, 16),
                    Diagnostic("GeneratedCodeAnalyzerId", "NestedGeneratedCode5").WithArguments("NestedGeneratedCode5").WithLocation(10, 16),
                    Diagnostic("GeneratedCodeAnalyzerId", "NestedGeneratedCode6").WithArguments("NestedGeneratedCode6").WithLocation(10, 16),
                    Diagnostic("GeneratedCodeAnalyzerId", "NestedGeneratedCode7").WithArguments("NestedGeneratedCode7").WithLocation(10, 16),
                    Diagnostic("GeneratedCodeAnalyzerId", "NestedGeneratedCode8").WithArguments("NestedGeneratedCode8").WithLocation(10, 16),
                    Diagnostic("GeneratedCodeAnalyzerId", "NestedGeneratedCode9").WithArguments("NestedGeneratedCode9").WithLocation(11, 16),
                    Diagnostic("GeneratedCodeAnalyzerId", "<").WithArguments("SourceFileRegular.vb").WithLocation(2, 1),
                    Diagnostic("GeneratedCodeAnalyzerId", "<").WithArguments("AssemblyInfo.vb").WithLocation(2, 1),
                    Diagnostic("GeneratedCodeAnalyzerId", "<").WithArguments("TemporaryGeneratedFile_036C0B5B-1481-4323-8D20-8F5ADCB23D92.vb").WithLocation(2, 1),
                    Diagnostic("GeneratedCodeAnalyzerId", "<").WithArguments("Test.designer.vb").WithLocation(2, 1),
                    Diagnostic("GeneratedCodeAnalyzerId", "<").WithArguments("Test.Designer.vb").WithLocation(2, 1),
                    Diagnostic("GeneratedCodeAnalyzerId", "<").WithArguments("Test.generated.vb").WithLocation(2, 1),
                    Diagnostic("GeneratedCodeAnalyzerId", "<").WithArguments("Test.g.vb").WithLocation(2, 1),
                    Diagnostic("GeneratedCodeAnalyzerId", "<").WithArguments("Test.g.i.vb").WithLocation(2, 1),
                    Diagnostic("GeneratedCodeAnalyzerId", "<").WithArguments("SourceFileWithAutoGeneratedComment.vb").WithLocation(3, 1)
                })
        End Sub
    End Class
End Namespace