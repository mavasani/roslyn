...
IInstanceReferenceOperation (InstanceReferenceKind.Base) (OperationKind.InstanceReference, Type: C1) (Syntax: 'MyBase')
]]>.Value
...
End Class]]>.Value
            ...
            Dim expectedOperationTree = <![CDATA[
IInstanceReferenceOperation (InstanceReferenceKind.Base) (OperationKind.InstanceReference, Type: System.Object, IsInvalid) (Syntax: 'MyBase')
]]>.Value
