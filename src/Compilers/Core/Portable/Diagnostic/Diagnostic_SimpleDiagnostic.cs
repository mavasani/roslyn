    ...
    public abstract partial class Diagnostic
    {
        internal sealed class SimpleDiagnostic : Diagnostic
        {
            ...
            private SimpleDiagnostic(
                ...
                bool isSuppressed,
                ImmutableHashSet<string> suppressingAnalyzers)
            {
                Debug.Assert(suppressingAnalyzers?.Count == 0 || isSuppressed);
                ...
                _suppressingAnalyzers = suppressingAnalyzers ?? ImmutableHashSet<string>.Empty;
            }
            ...
            internal static SimpleDiagnostic Create(
                ...
                ImmutableHashSet<string> suppressingAnalyzers = null)
            {
                return new SimpleDiagnostic(descriptor, severity, warningLevel, location, additionalLocations, messageArgs, properties, isSuppressed, suppressingAnalyzers);
            }
                                      ...
                                      ImmutableHashSet<string> suppressingAnalyzers = null)
            {
                ...
                return new SimpleDiagnostic(descriptor, severity, warningLevel, location, additionalLocations, messageArgs: null, properties, isSuppressed, suppressingAnalyzers);
            }
            ...
            internal override Diagnostic WithLocation(Location location)
            {
                ...
                {
                    return new SimpleDiagnostic(_descriptor, _severity, _warningLevel, location, _additionalLocations, _messageArgs, _properties, _isSuppressed, _suppressingAnalyzers);
                }
            ...
            internal override Diagnostic WithSeverity(DiagnosticSeverity severity)
            {
                if (this.Severity != severity)
                {
                    ...
                    return new SimpleDiagnostic(_descriptor, severity, warningLevel, _location, _additionalLocations, _messageArgs, _properties, _isSuppressed, _suppressingAnalyzers);
                }
            ...
            internal override Diagnostic WithIsSuppressed(bool isSuppressed)
            {
                ...
                {
                    return new SimpleDiagnostic(_descriptor, _severity, _warningLevel, _location, _additionalLocations, _messageArgs, _properties, isSuppressed, _suppressingAnalyzers);
                }
            ...
            internal override Diagnostic WithAnalyzerSuppressions(ImmutableHashSet<string> suppressingAnalyzers)
            {
                ...
                return new SimpleDiagnostic(_descriptor, _severity, _warningLevel, _location, _additionalLocations, _messageArgs, _properties, isSuppressed: true, suppressingAnalyzers);
            }
        }
    }
}
