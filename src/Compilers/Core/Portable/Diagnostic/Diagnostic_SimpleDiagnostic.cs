...
namespace Microsoft.CodeAnalysis
{
    ...
    public abstract partial class Diagnostic
    {
        internal sealed class SimpleDiagnostic : Diagnostic
        {
            ...
            {
                return new SimpleDiagnostic(descriptor, severity, warningLevel, location, additionalLocations, messageArgs, properties, suppressionInfo);
            }
            ...
            internal static SimpleDiagnostic Create(string id, LocalizableString title, string category, LocalizableString message, LocalizableString description, string helpLink,
                                      ...
                                      ImmutableDictionary<string, string> properties, DiagnosticSuppressionInfo suppressionInfo = null)
            {
                ...
                return new SimpleDiagnostic(descriptor, severity, warningLevel, location, additionalLocations, messageArgs: null, properties: properties, suppressionInfo: suppressionInfo);
            }
            ...
            internal override Diagnostic WithLocation(Location location)
            {
                ...
                {
                    return new SimpleDiagnostic(_descriptor, _severity, _warningLevel, location, _additionalLocations, _messageArgs, _properties, _suppressionInfo);
                }
            ...
            internal override Diagnostic WithSeverity(DiagnosticSeverity severity)
            {
                if (this.Severity != severity)
                {
                    ...
                    return new SimpleDiagnostic(_descriptor, severity, warningLevel, _location, _additionalLocations, _messageArgs, _properties, _suppressionInfo);
                }
            ...
            internal override Diagnostic WithSuppressionInfo(DiagnosticSuppressionInfo suppressionInfo)
            {
                ...
                {
                    return new SimpleDiagnostic(_descriptor, _severity, _warningLevel, _location, _additionalLocations, _messageArgs, _properties, suppressionInfo);
                }
