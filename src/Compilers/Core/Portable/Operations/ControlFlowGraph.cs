...
{
    /// <summary>
    /// Control flow graph representation for a given <see cref="OriginalOperation"/> executable code block.
    ...
    public sealed partial class ControlFlowGraph
    {
        ...
        /// <summary>
        /// Original operation, representing an executable code block, from which this control flow graph has been generated.
