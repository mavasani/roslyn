...
namespace Microsoft.CodeAnalysis.Diagnostics
{
    ...
    public abstract class AnalysisContext
    {
        ...
        /// <param name="action">Action to be executed for an <see cref="ISymbol"/>.</param>
        /// <param name="symbolKinds">Action will be executed only if an <see cref="ISymbol"/>'s Kind matches one of the <see cref="SymbolKind"/> values.</param>
        public void RegisterSymbolStartAction(Action<SymbolStartAnalysisContext> action, params SymbolKind[] symbolKinds)
        {
            this.RegisterSymbolStartAction(action, symbolKinds.AsImmutableOrEmpty());
        }
        ...
        /// <param name="action">Action to be executed for an <see cref="ISymbol"/>.</param>
        /// <param name="symbolKinds">Action will be executed only if an <see cref="ISymbol"/>'s Kind matches one of the <see cref="SymbolKind"/> values.</param>
        public virtual void RegisterSymbolStartAction(Action<SymbolStartAnalysisContext> action, ImmutableArray<SymbolKind> symbolKinds)
        {
