...
namespace Microsoft.CodeAnalysis.Diagnostics
{
    ...
    /// <summary>
    /// Context for suppressing analyzer diagnostics reported for the compilation.
    /// </summary>
    public struct SuppressionAnalysisContext
    {
        ...
        /// <summary>
        /// Suppressible analyzer diagnostics reported for the compilation.
        ...
        ///     1. Diagnostic is reported by an <see cref="DiagnosticAnalyzer"/>.
        ///     2. Diagnostic is not already suppressed in source via pragma/suppress message attribute.
        ///     3. Diagnostic's <see cref="Diagnostic.DefaultSeverity"/> is not <see cref="DiagnosticSeverity.Error"/>.
        ///     4. Diagnostic is not tagged with <see cref="WellKnownDiagnosticTags.NotConfigurable"/> custom tag.
        /// </summary>
        ...
        public void ReportSuppression(Suppression suppression)
        {
            ...
            {
                throw new ArgumentException(CodeAnalysisResources.DiagnosticSuppresorFeatureDisabled);
            }
