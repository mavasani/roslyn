...
namespace Microsoft.CodeAnalysis.Diagnostics
{
    ...
    internal sealed class AnalyzerAnalysisContext : AnalysisContext
    {
        ...
        public override void RegisterSymbolStartAction(Action<SymbolStartAnalysisContext> action, ImmutableArray<SymbolKind> symbolKinds)
        {
            DiagnosticAnalysisContextHelpers.VerifyArguments(action, symbolKinds);
            _scope.RegisterSymbolStartAction(_analyzer, action, symbolKinds);
        }
    ...
    //internal abstract class HostNestedAnalysisScope<TContainingAnalysisScope> : HostAnalysisScope
    //    where TContainingAnalysisScope : HostAnalysisScope
    //{
    //    private readonly TContainingAnalysisScope _containingScope;

    //    protected HostNestedAnalysisScope(TContainingAnalysisScope containingScope)
    //    {
    //        _containingScope = containingScope;
    //    }

    //    public sealed override AnalyzerActions GetAnalyzerActions(DiagnosticAnalyzer analyzer)
    //    {
    //        AnalyzerActions myActions = base.GetAnalyzerActions(analyzer);
    //        AnalyzerActions containerActions = _containingScope.GetAnalyzerActions(analyzer);
    ...
    //        return myActions.Append(containerActions);
    //    }
    //}
    ...
    internal sealed class HostCompilationStartAnalysisScope : HostAnalysisScope
    {
        ...
        {
            var compilationActions = base.GetAnalyzerActions(analyzer);
            var sessionActions = _sessionScope.GetAnalyzerActions(analyzer);
    ...
    internal abstract class HostAnalysisScope
    {
        ...
        public void RegisterSymbolStartAction(DiagnosticAnalyzer analyzer, Action<SymbolStartAnalysisContext> action, ImmutableArray<SymbolKind> symbolKinds)
        {
            var analyzerAction = new SymbolStartAnalyzerAction(action, symbolKinds, analyzer);
