...
{
    /// <summary>
    /// The base type for diagnostic suppressors that can programmatically suppress analyzer diagnostics.
    /// </summary>
    public abstract class DiagnosticSuppressor : DiagnosticAnalyzer
    {
        ...
        /// <summary>
        /// Suppress analyzer diagnostics reported for the compilation.
