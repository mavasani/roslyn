    ...
    internal class AnalyzerExecutor
    {
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return new AnalyzerExecutor(compilation, analyzerOptions, addNonCategorizedDiagnosticOpt, onAnalyzerException, isCompilerAnalyzer, 
                analyzerManager, shouldSkipAnalysisOnGeneratedCode, getAnalyzerGate, analyzerExecutionTimeMapOpt, addCategorizedLocalDiagnosticOpt, addCategorizedNonLocalDiagnosticOpt, cancellationToken);
        }
        ...
        public AnalyzerExecutor WithCancellationToken(CancellationToken cancellationToken)
        {
            ...
            return new AnalyzerExecutor(_compilation, _analyzerOptions, _addNonCategorizedDiagnosticOpt, _onAnalyzerException, _isCompilerAnalyzer,
                _analyzerManager, _shouldSkipAnalysisOnGeneratedCode, _getAnalyzerGateOpt, _analyzerExecutionTimeMapOpt, _addCategorizedLocalDiagnosticOpt, _addCategorizedNonLocalDiagnosticOpt, cancellationToken);
        }
