...
namespace Microsoft.CodeAnalysis.Diagnostics
{
    ...
    internal partial class AnalysisState
    {
        ...
        {
            RoslynDebug.Assert(analysisScope.FilterTreeOpt != null);
            RoslynDebug.Assert(analysisScope.FilterTreeOpt.SourceTree != null);

            var symbolDeclaredEvents = GetPendingSymbolDeclaredEvents(analysisScope.FilterTreeOpt.SourceTree, cancellationToken);
