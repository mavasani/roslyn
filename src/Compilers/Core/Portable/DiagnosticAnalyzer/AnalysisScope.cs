...
namespace Microsoft.CodeAnalysis.Diagnostics
{
    ...
    internal class AnalysisScope
    {
        ...
        public ImmutableHashSet<DiagnosticAnalyzer> Analyzers { get; private set; }
        ...
        public AnalysisScope(Compilation compilation, ImmutableArray<DiagnosticAnalyzer> analyzers, bool concurrentAnalysis, bool categorizeDiagnostics)
        {
            ...
            Analyzers = analyzers.ToImmutableHashSet();
        ...
        public bool ShouldAnalyze(DiagnosticAnalyzer analyzer)
        {
            return Analyzers.Contains(analyzer);
        }
