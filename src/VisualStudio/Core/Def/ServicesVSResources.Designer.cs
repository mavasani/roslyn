...
namespace Microsoft.VisualStudio.LanguageServices {
    ...
    internal class ServicesVSResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Analyzer assembly &apos;{0}&apos; cannot be loaded as another assembly with same name but different identity &apos;{1}&apos; has already been loaded in the process. You may need to restart the process for analyzers to work correctly..
        /// </summary>
        internal static string Analyzer_assembly_0_cannot_be_loaded_as_another_assembly_with_same_name_but_different_identity_1_has_already_been_loaded_in_the_process_You_may_need_to_restart_the_process_for_analyzers_to_work_correctly {
            get {
                return ResourceManager.GetString("Analyzer_assembly_0_cannot_be_loaded_as_another_assembly_with_same_name_but_diffe" +
                        "rent_identity_1_has_already_been_loaded_in_the_process_You_may_need_to_restart_t" +
                        "he_process_for_analyzers_to_work_correctly", resourceCulture);
            }
        }
