...
namespace Microsoft.CodeAnalysis.CodeRefactorings
{
    ...
    public abstract class CodeRefactoringProvider
    {
        ...
        internal virtual bool IsSupportedSyntaxNode(SyntaxNode node) => false;
        //internal virtual ImmutableArray<int> SupportedSyntaxTokenKinds => ImmutableArray<int>.Empty;
    }
}
