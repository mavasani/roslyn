...
namespace Microsoft.CodeAnalysis
{
    public static class DiagnosticExtensions
    {
            ...
            where TCompilation : Compilation
        {
            ...
            analyzerDiagnostics = driver.ApplyAnalyzerSuppressions(analyzerDiagnostics, newCompilation).AddRange(exceptionDiagnostics);

            diagnostics = includeCompilerDiagnostics ? compilerDiagnostics.AddRange(analyzerDiagnostics) : analyzerDiagnostics;
